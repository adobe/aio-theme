...
/**
 * Parse index records from static source files. For example for support of "iframe" directive:
 * https://github.com/adobe/gatsby-theme-aio#frame
 */
class CreateRecordsFromStatic {
  constructor(options = {}) {
...
module.exports = CreateRecordsFromStatic;
