...
const AdobeDeveloperConsole = ({ formData, handleChange, adobeDeveloperConsole }) => {
  return (
    <div css={css`display: flex; gap: 10px;`}>
      ...
      <p css={css`color:var(--spectrum-global-color-gray-800);margin:0;display:inline-flex;gap:5px;`}  className="spectrum-Body spectrum-Body--sizeXS">{adobeDeveloperConsole?.label}
        <a
