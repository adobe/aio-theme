...
const SEO = ({ title, description, keywords }) => (
  <>
    ...
    <link id="favicon" rel="icon" href="https://www.adobe.com/favicon.ico" type="image/x-icon" />
    <link id="favicon-shortcut" rel="shortcut icon" href="https://www.adobe.com/favicon.ico" type="image/x-icon" />
    ...
    {process.env.GATSBY_ADOBE_ANALYTICS_ENV && (
      <script id="marketingtech" src="https://www.adobe.com/marketingtech/main.standard.min.js" async></script>
    )}
  </>
  // <Helmet>
    // <html lang="en" />
