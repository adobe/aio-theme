              ...
              * {
              ...
              .api-content {
                ...
                td + td div div:first-of-type span + span {
                  ...
                  margin-bottom: calc(
                    var(--spectrum-taggroup-tag-gap-y, var(--spectrum-global-dimension-size-100)) / 2
                  );
                ...
                div div div div div button {
                  ...
                  display: list-item;
                  margin: 0;
                  border-bottom: var(--spectrum-accordion-item-border-size, var(--spectrum-alias-border-size-thin))
                    solid var(--spectrum-table-cell-border-color, var(--spectrum-global-color-gray-300));
                  color: var(--spectrum-body-text-color, var(--spectrum-alias-text-color));
                  background-color: inherit;
