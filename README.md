...
- [Adobe I/O Gatsby Theme](#adobe-io-gatsby-theme)
  - [Contents](#contents)
  ...
  - [Content structure](#content-structure)
    ...
    - [Google Docs support](#google-docs-support)
      ...
      - [Metadata](#metadata)
      - [Exclude folders or documents](#exclude-folders-or-documents)
  - [Configuration](#configuration)
    - [.env file](#env-file)
    - [.env settings for GitHub Contributors](#env-settings-for-github-contributors)
    - [.env settings for the Feedback Component and Analytics](#env-settings-for-the-feedback-component-and-analytics)
    - [.env settings for Algolia indexing](#env-settings-for-algolia-indexing)
